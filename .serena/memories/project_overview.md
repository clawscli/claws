...
## Purpose
Terminal UI for AWS resource management with cross-resource navigation, action support, and comprehensive AWS resource management.
...
├── custom/              # All 67 service implementations
│   ├── ec2/             # EC2 (8 resources)
│   ├── vpc/             # VPC (8 resources)
...
- **Cost**: risp, costexplorer, budgets
